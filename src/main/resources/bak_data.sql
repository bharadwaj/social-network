...
insert into social_network_2.userclass(id, isOpenFollow, isOpenMessage, isOpenProfile, name)
VALUES (1, true, true, true, 'Rajesh');
...
insert into social_network_2.Phonebrand(id,name) VALUES (4, 'Vivo');

insert into social_network_2.PhoneModel(id,name, phoneBrand_id) VALUES (1, 'J7', 1);
insert into social_network_2.PhoneModel(id,name, phoneBrand_id) VALUES (2, 'Karbonn 7', 2);
insert into social_network_2.PhoneModel(id,name, phoneBrand_id) VALUES (3, 'Note 34', 1);
insert into social_network_2.PhoneModel(id,name, phoneBrand_id) VALUES (4, 'G7', 4);
insert into social_network_2.PhoneModel(id,name, phoneBrand_id) VALUES (5, 'V20', 4);
insert into social_network_2.PhoneModel(id,name, phoneBrand_id) VALUES (6, 'V30', 4);
insert into social_network_2.PhoneModel(id,name, phoneBrand_id) VALUES (7, 'S9 Plus', 1);
