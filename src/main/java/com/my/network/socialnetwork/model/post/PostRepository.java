...
public interface PostRepository extends PagingAndSortingRepository<Post, Long> {
    ...
    @Query(value = "(SELECT p.* FROM social_network_3.Post p " +
            ...
            " INNER JOIN social_network_3.PostVisibility pv ON p.id = pv.post_id " +  // for friends only post
            ...
            " INNER JOIN social_network_3.Following B ON A.user_id = B.following_user_id " +   // for the users following the userId
